...
TEST_F(DesTest, des_ip_permutation) {
    uint8_t plainText[8] = {0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef};
    uint8_t left[4] = {0};
    uint8_t right[4] = {0};
...
TEST_F(DesTest, des_pc1_permutation) {
    uint8_t key[8] = {0x13, 0x34, 0x57, 0x79, 0x9b, 0xbc, 0xdf, 0xf1};
    uint8_t C[4] = {0};
    uint8_t D[4] = {0};
...
TEST_F(DesTest, des_generate_keys) {
    uint8_t key[8] = {0x13, 0x34, 0x57, 0x79, 0x9b, 0xbc, 0xdf, 0xf1};
    uint8_t keys[16][6] = {{0}};
    uint8_t key_1[6] = {0x1b, 0x02, 0xef, 0xfc, 0x70, 0x72};
