...
void aes_encrypt_plus(uint8_t *plainText, uint8_t *key, uint8_t *cipherText) {
    uint8_t keys[176] = {0};
    aes_key_expand(key, keys);
    int i;
    ...
    // 9 rounds
    for (i = 1; i < 10; ++i) {
        tempColumn0 = T0[(uint8_t) column0] ^ T1[(uint8_t) (column1 >> 8)] ^ T2[(uint8_t) (column2 >> 16)] ^
                      T3[column3 >> 24];
        tempColumn1 = T0[(uint8_t) column1] ^ T1[(uint8_t) (column2 >> 8)] ^ T2[(uint8_t) (column3 >> 16)] ^
                      T3[column0 >> 24];
        tempColumn2 = T0[(uint8_t) column2] ^ T1[(uint8_t) (column3 >> 8)] ^ T2[(uint8_t) (column0 >> 16)] ^
                      T3[column1 >> 24];
        tempColumn3 = T0[(uint8_t) column3] ^ T1[(uint8_t) (column0 >> 8)] ^ T2[(uint8_t) (column1 >> 16)] ^
                      T3[column2 >> 24];
...
void aes_generate_t_tables() {
    ...
    for (i = 0; i < 256; ++i) {
        t0[i] = ((uint32_t) SBOX3[i] << 24) ^ ((uint32_t) SBOX[i] << 16)
                ^ ((uint32_t) SBOX[i] << 8) ^ ((uint32_t) SBOX2[i]);
        t1[i] = ((uint32_t) SBOX[i] << 24) ^ ((uint32_t) SBOX[i] << 16)
                ^ ((uint32_t) SBOX2[i] << 8) ^ ((uint32_t) SBOX3[i]);
        t2[i] = ((uint32_t) SBOX[i] << 24) ^ ((uint32_t) SBOX2[i] << 16)
                ^ ((uint32_t) SBOX3[i] << 8) ^ ((uint32_t) SBOX[i]);
        t3[i] = ((uint32_t) SBOX2[i] << 24) ^ ((uint32_t) SBOX3[i] << 16)
